      ...
      <div class="container">
        <div class="row justify-content-center">
          ...
          <div class="col-md-5">
 			<p>
				ARTICLE 1 : Objet <br/>
				Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site ldap-egnom.pro et leur utilisation par « l'Utilisateur ».<br/>
				...
				ldap-egnom.pro se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes conditions générales d'utilisation.<br/>

				ARTICLE 2 : Mentions légales<br/>
				L'édition du site ldap-egnom.pro est assurée et est hébergé par la Société Lycée Gaspard Monge situé au 2 Avenue de Saint-Julien, 08000 Charleville-Mézières<br/>
				...
				Connexion a internet sur le réseau EGNOM-BYOD;<br/>

				Connexion au VPN VPN_STUDENT<br/>
				...
				Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du réseau ou du serveur n'engage pas la responsabilité de ldap-egnom.pro.<br/>
				...
				L'Utilisateur a la possibilité de contacter le site par messagerie électronique à l'adresse prof@trionfini.com.<br/>
				...
				Le contenu de l'Utilisateur peut être à tout moment et pour n'importe quelle raison supprimé ou modifié par le site. L'Utilisateur ne reçoit aucune justification et notification préalablement à la suppression ou à la modification du contenu Utilisateur.<br/>
				...
				En vertu des articles 48 et suivants de la loi n° 78-17 relative à l'informatique, aux fichiers et aux libertés en date du 6 janvier 1978, réécrite par l'ordonnance n° 2018-1125 du 12 décembre 2018 applicable au 1er juin 2019, l'Utilisateur dispose d'un droit d'accès, de rectification, de suppression et d'opposition de ses données personnelles. L'Utilisateur exerce ce droit via :<br/>

				par mail à prof@trionfini.com;<br/>

				par voie postale au 2 Avenue de Saint-Julien, 08000 Charleville-Mézières.<br/>
				...
				ARTICLE 8 : Évolution du contrat<br/>
				Le site se réserve à tout moment le droit de modifier les clauses stipulées dans le présent contrat.<br/>

				ARTICLE 9 : Durée<br/>
				La durée du présent contrat est déterminée selon la durée de la scolarité de l'Utilisateur dans l'enceinte de l'établissement. Le contrat produit ses effets à l'égard de l'Utilisateur à compter de l'utilisation du service.<br/>

				ARTICLE 10: Droit applicable et juridiction compétente<br/>
				La législation française s'applique au présent contrat. En cas d'absence de résolution amiable d'un litige né entre les parties, seuls les tribunaux du ressort de la Cour d'appel de la ville de Reims sont compétents.<br/>
 			</p>
